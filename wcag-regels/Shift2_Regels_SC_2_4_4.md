...
- **LOGO OP EEN SUBSITE dat naar de eigen homepage linkt.** Is de toegankelijke naam alleen de organisatienaam ("Logo gemeente X"), dan is dat een AFKEURING onder 2.4.4 (klein, ontwikkelaar). Wie het hoort verwacht de hoofdsite van de organisatie en komt op de homepage van de subsite uit: de naam voorspelt een andere bestemming dan waar de link heen gaat. Speelt bij elke gemeentelijke subsite (duurzaam., open., mijn., bo.).
  Advies: neem de bestemming op in het tekstalternatief van het logo, bijvoorbeeld "Logo gemeente X, Website Duurzaam X". Dat alternatief is hier namelijk de toegankelijke naam van de link: er staat geen andere tekst in de link.
  **Dit is GEEN 1.1.1-bevinding.** Daar is de vraag of het alternatief weergeeft wát de afbeelding is, en "Logo gemeente X" bij dat logo doet dat precies. Tot 2026-09-22 stond deze regel onder 1.1.1, met een motivering die over de bestemming van de link ging; dat was het verkeerde criterium. Vastgelegd door Frits op 2026-09-22 bij ZOET-01 (B001), waar 1.1.1 op de homepage om deze reden juist voldoet. Vier oudere bevindingen zijn mee verplaatst: B003 op open.beverwijk.nl en B017 op duurzaam.beverwijk, elk in de nulmeting en de tussencheck. QuickFinding b7a229bb hoort hierbij.
