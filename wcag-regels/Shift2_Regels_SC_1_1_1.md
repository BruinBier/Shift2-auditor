...
- LOGO OP EEN SUBSITE dat linkt naar de homepage van die subsite: dit is GEEN 1.1.1-bevinding. Het hoort onder **2.4.4**; zie `Shift2_Regels_SC_2_4_4.md`.
  ...
  1.1.1 vraagt of het tekstalternatief weergeeft wát de afbeelding is. "Logo gemeente Zoetermeer" bij het logo van gemeente Zoetermeer doet dat precies; waar de link heen gaat is een eigenschap van de link. Dat die alt tegelijk de toegankelijke naam van de link is, maakt hem nog geen onjuist tekstalternatief.
  Vastgelegd door Frits op 2026-09-22 bij ZOET-01 (B001). Dezelfde fout is gemaakt bij BEV-03 B017 en BEV-04 B003; die onderzoeken zijn afgerond en niet met terugwerkende kracht gewijzigd.
