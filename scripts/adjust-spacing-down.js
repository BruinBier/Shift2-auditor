...
// Adjust spacing from 4800 to 5600 (a bit more down)
xml = xml.replace(
  /(<w:spacing w:before=")4800("\/><w:jc w:val="right"\/><\/w:pPr><w:r><w:rPr><w:b\/><w:bCs\/><w:sz w:val="22"\/><w:szCs w:val="22"\/><\/w:rPr><w:t>Opdrachtgever:)/g,
  '$15600$2'
);
...
console.log('\n✅ Spacing adjusted - block moved down slightly');
