...
// Adjust spacing from 6400 to 6800 (a little bit more)
xml = xml.replace(
  /(<w:spacing w:before=")6400("\/><w:jc w:val="right"\/><\/w:pPr><w:r><w:rPr><w:b\/><w:bCs\/><w:sz w:val="22"\/><w:szCs w:val="22"\/><\/w:rPr><w:t>Opdrachtgever:)/g,
  '$16800$2'
);
...
console.log('\n✅ Spacing adjusted - block moved down a little more');
