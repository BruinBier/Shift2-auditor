...
async function fix141() {
  console.log('Fixing criterion 1.4.1...\n');
  ...
  if (index === -1) {
    console.error('❌ 1.4.1 not found in table');
    process.exit(1);
  }
  ...
  // Find 1.4.1 again
  index = xmlContent.indexOf('1.4.1');
  while (index !== -1 && index < 50000) {
    index = xmlContent.indexOf('1.4.1', index + 1);
  }
  ...
  console.log('\n✅ Criterion 1.4.1 fixed successfully!');
