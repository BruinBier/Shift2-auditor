...
**Export Date:** 2026-04-17T16:30:14.631Z
**Backup Name:** backup-2026-04-17-16-30-14
...
- findings.csv (147 records)
- finding_urls.csv (0 records)
- finding_occurrences.csv (149 records)
- sample_items.csv (121 records)
...
- quick_findings.csv (112 records)
- teams.csv (1 records)
...
npm run restore backups/backup-2026-04-17-16-30-14
```
