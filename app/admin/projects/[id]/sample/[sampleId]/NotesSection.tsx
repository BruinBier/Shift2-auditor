...
export default function NotesSection({ sampleItemId, initialNotes }: NotesSectionProps) {
    ...
    <>
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="p-6 border-b border-gray-200 flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold">Notities</h2>
            ...
            {showTooltip && (
              <>
                ...
                <div className="absolute left-1/2 -translate-x-1/2 top-8 z-50 w-80 bg-gray-900 text-white text-sm rounded-lg shadow-lg p-4">
                  ...
                  <div className="relative">
                    <p className="mb-2">
                      Gebruik dit veld om notities toe te voegen aan deze pagina tijdens het onderzoek.
                    </p>
                    <p>
                      Notities worden opgeslagen per pagina en zijn alleen zichtbaar voor het auditteam.
                    </p>
                  </div>
                </div>
              </>
        ...
        <div className="p-6">
          ...
          <div className="mt-4 flex gap-2">
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="modal-save-button px-6 py-2 text-white rounded-md text-sm font-medium transition-colors disabled:opacity-50"
            >
