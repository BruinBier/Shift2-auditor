            ...
            {managementSummary ? (
              ...
              <>
                ...
                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
                  <strong>Automatisch gegenereerd</strong> - Deze samenvatting is automatisch gegenereerd op basis van de projectgegevens. Klik op 'Bewerken' om aan te passen of 'Genereer met AI' voor een AI-gegenereerde versie.
                </div>
              </>
            ) : (
